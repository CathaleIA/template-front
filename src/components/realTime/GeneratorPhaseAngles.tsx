...
interface GeneratorPhaseAnglesProps {
  generatorData: GeneratorPhaseData;
  title?: string;
}

const GeneratorPhaseAngles = ({
  generatorData,
  title = 'Ángulos de Fase - Generador',
}: GeneratorPhaseAnglesProps) => {
  ...
  const angles = useMemo(() => {
    ...
    const a = getAngle(generatorData.angulo_fase_A);
    const b = getAngle(generatorData.angulo_fase_B);
    const c = getAngle(generatorData.angulo_fase_C);
  ...
  const updatePlot = async (
    ...
    try {
      ...
      console.error('Error al actualizar plot del generador:', error);
    }
  };
...
export default GeneratorPhaseAngles;