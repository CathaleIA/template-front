    ...
    return (
        <div className="flex flex-col lg:grid lg:grid-cols-4 lg:grid-rows-4 gap-4 h-[calc(100svh-var(--header-height)-var(--tablist-height))]!">
            ...
            <div className="col-span-3 row-span-2">
                <div className='flex flex-col bg-bg-white  h-full card-plotly3'>
                    <div className='flex justify-center items-center bg-input/50 w-[35%] h-[35px] pr-2 rounded-br-full text-primary '>
            ...
            <div className="col-span-1 row-span-3">
                <div
                    className='flex flex-col bg-bg-white  h-full w-full card-plotly3'
                >
                    <div className='flex justify-center items-center bg-input/50 w-[35%] h-[35px] pr-2 rounded-br-full text-primary '>
                        <h1 className="text-xs font-bold leading-none tracking-tight text-muted-foreground uppercase">
                            ANGULOS</h1>
            ...
            <div className="col-span-1 row-span-2">
                <div className='flex flex-col bg-bg-white  h-full card-plotly3'>
                    <div className='flex justify-center items-center bg-input/50 w-[55%] h-[35px] pr-2 rounded-br-full text-primary '>
                        <h1 className="text-xs font-bold leading-none tracking-tight text-muted-foreground uppercase">
                            FACT. DE POTENCIA</h1>
                    </div>
