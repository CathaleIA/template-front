...
export default function TabConjuntoMotor({ engine, gvl }: Props) {
    ...
    return (
        <div className="h-full flex flex-col gap-2 p-3 overflow-hidden">
            ...
            {/* FILA TOP: Gauge + Devanados + Actuadores — todo en una línea compacta */}
            ...
            {/* ÁREA PRINCIPAL: sidebar izquierdo + knock chart */}
            <div className="flex-1 min-h-0 flex gap-2">

                {/* SIDEBAR: Cilindros + Sistema — ancho fijo */}
                <div className="w-72 shrink-0 flex flex-col gap-2 min-h-0">
                    ...
                    {/* Sistema: 2×2, reparte el espacio disponible */}
                ...
                <div className="flex-1 min-h-0 min-w-0 rounded-lg border bg-card p-2.5 flex flex-col">
                    ...
                    <VibTrendsChart data={gvl} historyKey="gen03_vibrations" accentColor="#60a5fa" />
                </div>
            </div>
        </div>
    );
