  ...
  return (
    <>
      ...
      <div className="grid grid-cols-4 gap-y-2 text-center">
        ...
        {/* ---------- VALORES ---------- */}
        {/* ---------- VALORES ---------- */}
        <h3 className="text-3xl font-bold text-gray-900">{(activa ?? 0).toFixed(0)}</h3>
        <h3 className="text-3xl font-bold text-gray-900">{(reactiva ?? 0).toFixed(0)}</h3>
        <h3 className="text-3xl font-bold text-gray-900">{(aparente ?? 0).toFixed(0)}</h3>
        <h3 className="text-3xl font-bold text-gray-900">{(fp ?? 0).toFixed(0)}%</h3>
